class Employee:
    """ This is doctstring for employee orgnisation """
    # class variable
    orgnisation_name = "CDAC"    
    
    # initialiser
    def __init__(self,rcv_emp_id,rcv_name,rcv_base_location,rcv_deployed_location,rcv_designation,salary):
        # instance variable
        self.__emp_id = rcv_emp_id
        self.__emp_name = rcv_name      # private instance variable 
        self._employee_base_location = rcv_base_location   # protected instance variable
        self.employee_deployed_location = rcv_deployed_location # public instance variable 
        self.employee_designation = rcv_designation # public instance variable 
        print(f"{self} was created successfully with values {rcv_emp_id},{rcv_name},{rcv_base_location},{rcv_deployed_location},{rcv_designation}")

    # instance method
    def get_employee_details(self):
        return self.employee_enrolled_designation_name
